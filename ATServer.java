...
public class ATServer {
        ...
        try{
            ...
            while(true){
                ...
                if(b.equals("Avatar") || b.equals("Titanic") || b.equals("Avengers")){
                    System.out.println("Sending the Schedule of Atwater Movie Theater");
    ...
    public static void main(String[] args) {
        int number = 1;
        try{
//            File file = new File("Atwater Server Log #"+number);
...
//            list2.add("");
//            list3.add("");
//            innerMap.put("ATWM160523",list);
//            innerMap2.put("ATWN160523",list2);
//            innerMap3.put("ATWE160523",list3);
            ...
            Thread t = new Thread(()->connect(obj));
            t.start();
        }
        catch (Exception e){
            e.printStackTrace();
