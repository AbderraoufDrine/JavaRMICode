...
public class VrServer {
        ...
        try{
            ...
            while(true){
                ...
                if(b.equals("Avatar") || b.equals("Titanic") || b.equals("Avengers")){
                    System.out.println("Sending the Schedule of Verdun Movie Theater");
    ...
    public static void main(String[] args) {
        int number = 1;
        try {
//            File file = new File("Verdun Server Log #"+number);
...
//            list2.add("");
//            list3.add("");
//            innerMap.put("VERM160523",list);
//            innerMap2.put("VERN160523",list2);
//            innerMap3.put("VERE160523",list3);
